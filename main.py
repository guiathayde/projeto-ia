# -*- coding: utf-8 -*-
"""Cópia de Toxic_Language_PTBR_Classification.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1p0kb-Poi5OtYqO8q7bV1DrSL2GboxlcD
...
#Regressão Logística
#predictions_test = lr_model.predict(X_final.toarray())

#Rede Neural
predictions_test = model.predict(X_final_count.toarray())

predictions_test

len(predictions_test)

predicao = pd.DataFrame(predictions_test)
predicao.columns = ['predicted']

predicao['label'] = [1 if y >=0.5 else 0 for y in predicao['predicted']]
predicao

submission = predicao.drop(['predicted'], axis= 1)
submission
